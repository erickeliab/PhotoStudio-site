                ...
                <div class="container"> @include('inc.alerts')
                    ...
                    <div class=" well justify-content-center bg-white" style=" padding:2em;">
                        <center>
                            ...
                            <a href="javascript:void(0)" data-toggle="modal" data-target="#add-new-image" style="padding:2em;" class="btn m-t-20 btn-dark btn-rounded col-md-4 waves-effect waves-light">
                                    <i class="ti-plus"></i> Upload Image</a>
                        </center>
                    </div>
                    <hr>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card">
                                <div class="el-card-item">
                                    <div class="el-card-avatar el-overlay-1"> <img src="{{URL::asset('storage/CoverImages/'.$gall->path)}}" alt="user" style="height:320px;"/>
